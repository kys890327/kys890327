			...
			<div class="col-lg-8">
				<div class="blog_left_sidebar">
					...
					<nav class="blog-pagination justify-content-center d-flex">
						<ul class="pagination">
							<li class="page-item"><a href="/blog/board?cmd=list&page=${param.page-1 }" class="blog_btn" aria-label="Previous"> <span aria-hidden="true"> <span class="lnr lnr-chevron-left"></span>
								</span>
							</a></li>

							<li class="page-item"><a href="/blog/board?cmd=list&page=${param.page+1 }" class="blog_btn" aria-label="Next"> <span aria-hidden="true"> <span class="lnr lnr-chevron-right"></span>
								</span>
							</a></li>
						</ul>
					</nav>
